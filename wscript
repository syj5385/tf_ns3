...
def configure(conf):
    ...
    env.append_value('LDFLAGS', '-ltensorflow_framework')
    env.append_value('LDFLAGS', '-ltensorflow_cc')
    env.append_value('LINKFLAGS', '-Wl,--no-as-needed')
	#env.append_value('LINKFLAGS', ['-Ltensorflow/lib', '-Itensorflow/include'])
	#env.append_value('LDFLAGS', '-Llib')
